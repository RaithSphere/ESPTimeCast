...
<html lang="en">
  ...
  <body>
    <form id="configForm" onsubmit="submitConfig(event)">
      ...
      <div class="content-wrapper" style="margin-bottom: 1rem">
                <div class="top-status-panel">
          <div class="status-tile">
            <div class="status-title">Live Device / Matrix</div>
            <div><strong>Display:</strong> <span id="screenMode">--</span></div>
            <br />
            <span
              id="screenMirror"
              style="
                ...
                background:
                  ...
                  repeating-linear-gradient(
                    to right,
                    rgba(125, 255, 154, 0.08) 0 1px,
                    transparent 1px 4px
                  ),
                  repeating-linear-gradient(
                    to bottom,
                    rgba(125, 255, 154, 0.06) 0 1px,
                    transparent 1px 4px
                  ),
                  #101b13;
                ...
                padding: 6px 8px;
                box-shadow:
                  inset 0 0 0 1px rgba(125, 255, 154, 0.15),
                  0 0 12px rgba(44, 255, 122, 0.22);
            ...
            <div
              class="small"
              style="margin: 0.5rem 0 0.35rem 0; color: #95ffb4"
            >
              Last 5 screen states:
            </div>
            <ol
              id="screenHistory"
              style="
            ...
            <div style="margin-top: 0.6rem">
              <label for="screenPollRate">Screen mirror refresh:</label>
              <select
                id="screenPollRate"
                onchange="setScreenPollInterval(this.value)"
              >
          ...
          <div class="status-tile device-info">
            <div class="status-title">Indoor Sensor (AHT20 + BMP280)</div>
            <ul class="status-list">
              <li>Enabled: <span id="indoorEnabled">No</span></li>
              <li>Available: <span id="indoorAvailable">No</span></li>
              <li>Temp: <span id="indoorTemp">-- &#176;C</span></li>
              <li>Raw Temp: <span id="indoorRawTemp">-- &#176;C</span></li>
              <li>Humidity: <span id="indoorHumidity">-- %</span></li>
              <li>Pressure: <span id="indoorPressure">-- hPa</span></li>
            </ul>
          </div>

          <div class="status-tile">
            <div class="status-title">Current Time & Outdoor Temp</div>
            <div>Clock: <span id="panelClock">--:--:--</span></div>
            <div>Outdoor: <span id="panelOutdoorTemp">--</span></div>
          </div>
        </div>
      </div>
